...
class CONSULTARCIUDADANO : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_consultarciudadano)
        ...
        buttonSiguiente.setOnClickListener {
            startActivity(Intent(this, CONSULTARCIUDADANORESULTADO::class.java))
        }
    }
}